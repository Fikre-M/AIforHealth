      ...
      <Section background="gradient" padding="xl">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Smart scheduling, AI health guidance, and automated reminders - 
            all in one platform. Take control of your healthcare journey today.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              Our AI-powered platform learns your health patterns, predicts your needs, 
              and ensures you never miss important appointments or follow-ups.
            </p>
