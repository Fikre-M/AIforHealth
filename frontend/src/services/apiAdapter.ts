...
export const apiAdapter = {
  // Auth methods
  auth: {
    login: (credentials: any) => api.post('/auth/login', credentials).then((res) => res.data.data),

    register: (data: any) => api.post('/auth/register', data).then((res) => res.data.data),
    ...
    getProfile: () => api.get('/auth/profile').then((res) => res.data.data.user),

    updateProfile: (data: any) => api.put('/auth/profile', data).then((res) => res.data.data.user),
  },
  ...
  notifications: {
    ...
    markAllAsRead: () => api.put('/notifications/mark-all-read').then((res) => res.data.data),

    deleteNotification: (id: string) => api.delete(`/notifications/${id}`).then((res) => res.data),
  },
