...
export {
  ...
  authValidators as validateUserRegistration,
  authValidators as validateUserLogin,
  appointmentValidators as validateAppointmentCreation,
  patientValidators as validatePatientCreation,
  // ... etc
};
