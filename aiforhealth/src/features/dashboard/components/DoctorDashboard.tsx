...
export function DoctorDashboard() {
  ...
  const handleAppointmentStatusChange = async (appointmentId: string, status: DoctorAppointment['status']) => {
    try {
  ...
  const handleApproveRequest = async (requestId: string) => {
    try {
      await doctorService.approveAppointmentRequest(requestId);
  ...
  const handleRejectRequest = async (requestId: string) => {
    try {
      await doctorService.rejectAppointmentRequest(requestId);
      setAppointmentRequests(prev => 
        prev.map(req => 
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {appointmentRequests.length > 3 && (
                  <div className="text-center pt-2">
                    <Button variant="outline" size="sm">
                      View All Requests ({appointmentRequests.length - 3} more)
                    </Button>
                  </div>
                )}
              </div>
        ...
        <div className="space-y-6">
              ...
              {patients.length > 3 && (
                <div className="text-center pt-2">
                  <Button variant="outline" size="sm" className="w-full">
                    View All Patients ({patients.length - 3} more)
                  </Button>
                </div>
              )}
            </div>
          ...
          {/* AI Patient Summary Placeholder */}
          <DashboardWidget
          ...
          >
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-medical-50 to-blue-50 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-3">
                  <MessageCircle className="h-5 w-5 text-medical-600" />
                  <span className="font-medium text-medical-800">AI Summary</span>
                </div>
              ...
              <div className="bg-yellow-50 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="font-medium text-yellow-800">Priority Actions</span>
                </div>
